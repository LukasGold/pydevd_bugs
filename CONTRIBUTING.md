...
Welcome to `pydevd_bugs` contributor's guide.
...
If you experience bugs or general issues with `pydevd_bugs`, please have a look
...
You can help improve `pydevd_bugs` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`pydevd_bugs` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `pydevd_bugs`'s files. While this mechanism can
...
```
conda create -n pydevd_bugs python=3 six virtualenv pytest pytest-cov
conda activate pydevd_bugs
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/pydevd_bugs.git
   cd pydevd_bugs
   ```
...
5. Install [pre-commit]:
   ...
   `pydevd_bugs` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/pydevd_bugs
[issue tracker]: https://github.com/<USERNAME>/pydevd_bugs/issues
